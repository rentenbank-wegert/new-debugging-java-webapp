...
# Server Download und Bereitstellung
...
# Serverconfig kopieren
mkdir -p /home/vscode/.rsp/redhat-community-server-connector/servers/
cp /workspaces/new-debugging-java-webapp/.devcontainer/tmpServerConnector-apache-tomcat-11.0.0-M6--263-QmZp4o8oN0m8-.json /home/vscode/.rsp/redhat-community-server-connector/servers/apache-tomcat-11.0.0-M6
